...
namespace Absher.Persistence.Migrations
{
    ...
    [Migration("20220921201654_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Absher.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Absher.Domain.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Absher.Domain.Post", b =>
                {
                    b.HasOne("Absher.Domain.Category", "Category")
                        .WithMany("Blogs")
